...
function DetailModal({
  ...
  const buildPayload = () => {
    ...
    return {
      ...
      designMeetingAt: designMeetingDone ? ((designMeetingInputRef.current?.value?.trim() || data.designMeetingAt) ?? undefined) : ((fd.get("designMeetingAt") as string)?.trim() || undefined),
